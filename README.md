...
## C++ के Features
- Object Oriented Programming (OOP) को support करता है  
- यह बहुत तेजी से execute होती है  
- Portable language है (अलग-अलग platforms पर run हो सकती है)  
- Rich library प्रदान करती है  
- Code को बार-बार use करने की सुविधा देता है  

## C++ का उपयोग (Use Cases)
